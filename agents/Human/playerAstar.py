...
class myAgent(Agent):
    ...
    def SelectAction(self, actions, game_state):
        ...
        print("hand",hypothetical.agents[agent_id].hand)
        ...
        # print("heiefnlnasln",self.seqHeuristic(hypothetical,agent_id)) 
        priorQueue = PriorityQueue()
        startNode = (hypothetical, '',0, [])
    ...
    def seqHeuristic(self,state,agent_id):
        ...
        heuristicValue=10-(maxScore+seqScore)
